    ...
    <body>
        ...
        <div class="wrapper-page">
            ...
            <div class="m-t-40 card-box">
                ...
                <div class="p-20">
                    <form class="form-horizontal m-t-20" action="dangnhap" method="post">
                    <input type="hidden" name="_token" value="{{csrf_token()}}" >
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control"  id="user_email" type="text" required="" name="email" placeholder="Username">
                            </div>
                        </div>

                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" id="user_password" type="password" required="" name="password" placeholder="Password">
                            </div>
                        </div>
